...
## แบบฝึกหัดที่ 4: เรียบเรียงเป็นรายงานเสนอผู้บริหาร

รีพอร์ทค้นคว้ากับรายงานเสนอผู้บริหาร**ไม่ใช่เอกสารเดียวกัน** — อันแรกเขียนให้เราเรียนรู้ อันหลังเขียนให้คนตัดสินใจ

**หน้าที่ของเราในขั้นนี้คือกำกับ ไม่ใช่ปล่อยให้ AI เรียบเรียงเอง** — เพราะเราคือคนที่อ่านรีพอร์ทมาแล้ว และรู้ว่าอะไรสำคัญต่อผู้บริหารของเรา

```prompt
จากรีพอร์ทค้นคว้าที่ทำไว้ ช่วยเรียบเรียงเป็นรายงานเสนอผู้บริหาร ความยาวไม่เกิน 2 หน้า
ตามโครงสร้างนี้:

1. ข้อเสนอ (ครึ่งหน้า) — เราควรทำอะไร เสนอมา 2-3 ทางเลือกพร้อมข้อดีข้อเสีย
2. เหตุผลรองรับ — อ้างอิงจากสิ่งที่ค้นมา ทุกข้อมีลิงก์กำกับ
3. ต้นแบบที่แนะนำให้อ้างอิง — เลือกมา 2 แห่ง บอกว่าทำไมเลือกแห่งนั้น และเราจะหยิบส่วนไหนมาใช้
4. สิ่งที่ยังไม่รู้และผลกระทบต่อการตัดสินใจ — ถ้าตัดสินใจตอนนี้ เสี่ยงตรงไหน
5. ขั้นตอนถัดไป — ใครต้องทำอะไร ภายในเมื่อไหร่

กฎ:
- ใช้เฉพาะข้อมูลจากรีพอร์ท ห้ามเพิ่มข้อมูลใหม่
...
**สังเกตว่าพรอมต์นี้กำหนด 3 อย่างที่รีพอร์ทเดิมไม่มี:**
...
| **"เสนอ 2-3 ทางเลือก"** | รายงานที่มีข้อเสนอเดียวคือการตัดสินใจแทนผู้บริหาร ไม่ใช่การเสนอ |
| **"ข้อที่ยืนยันไม่ได้ ห้ามเขียนเป็นข้อเท็จจริง"** | จุดที่ผิดพลาดง่ายที่สุดตอนย่อรีพอร์ท — ⚠️ ในรีพอร์ทมักหายไปตอนเรียบเรียงใหม่ |

!!! danger "อ่านทั้งฉบับก่อนส่งเสมอ"
    โดยเฉพาะ **ข้อ 2 (เหตุผลรองรับ)** — เช็คว่าทุกข้อยังมีลิงก์กำกับอยู่ และไม่มีข้อไหนที่ถูกยกระดับจาก "ยืนยันไม่ได้" มาเป็น "ข้อเท็จจริง" ระหว่างการย่อ
...
| 4 | กำกับ AI เรียบเรียงเป็นรายงานเสนอผู้บริหาร | รีพอร์ทค้นคว้ากับรายงานเสนอ ไม่ใช่เอกสารเดียวกัน |
...
!!! note "หลักการใช้ให้ถูกต้อง"
    ...
    6. **กำกับโครงสร้างตอนเรียบเรียงรายงาน** — AI ไม่รู้ว่าผู้บริหารของเราอยากเห็นอะไรก่อน
...
??? quote "ลิงก์สำหรับอาจารย์เท่านั้น"
    บทสนทนา Claude Cowork ที่ใช้สาธิตทั้ง 4 แบบฝึกหัดในหน้านี้ —
